...
namespace MultiLangApp.Localization
{
    public class LocalizationManager
    {
        ...
        public void SwitchLanguage(string cultureCode)
        {
            try
            {
                ...
                string uriStr = string.Format("pack://application:,,,/MultiLangApp;component/Localization/StringResources.{0}.xaml", cultureCode);
